    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locale', models.CharField(choices=[('en_US', 'English (United States)')], default='en_US', max_length=7)),
                ...
                ('feature_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='article_feature_images', to='articles.photo')),
                ('og_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='article_og_images', to='articles.photo')),
                ('twitter_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='article_twitter_images', to='articles.photo')),
            ],
        ),
        migrations.CreateModel(
